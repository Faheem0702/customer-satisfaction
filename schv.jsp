...
<div id="body1">
<br/>
<h1 align="center">Get SLA Period of Cloud Activated and Expiry Date</h1>
</div>
<div id="bodymiddlePan">
  	 <form id="form1" name="form1" method="post" action="ViewSla.jsp">
...
<p>&nbsp;</p><p>&nbsp;</p>
	...
	<tr>
		...
		<td><input type="submit" name="Submit" value="Get SLA Period" /></td>
	</tr>
</table>
