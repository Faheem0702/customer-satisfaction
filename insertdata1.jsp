...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from apms_enduser  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into apms_enduser(name,pass,email,mobile,addr,dob,location,cloudname,imagess) values(?,?,?,?,?,?,?,?,?)");
