...
<div id="body1"><br />
<h1 align="center">View Transaction Details!!!</h1>
</div>
<div id="bodymiddlePan">
  	 ...
  	 <form id="form1" name="form1" method="post" action="ViewTransactions.jsp">
...
<%
	...
	int i=0,j=0,k=0;
      	...
      	try 
	{
      		if(cname.equalsIgnoreCase("Eucalyptus")||cname.equalsIgnoreCase("Nimbus")||cname.equalsIgnoreCase("AmazonEC2")){
          %>
</span>
