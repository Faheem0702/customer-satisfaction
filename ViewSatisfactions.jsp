...
<div id="body1"><br />
<h1 align="center">The Customer Satisfactions </h1>
</div>
<div id="bodymiddlePan">
       
	   
	   <p><span class="style8"><a href="View_Negative_Satisfactions.jsp"><br />
             <span class="style9">1. View Negative Satisfactions</span></a></span><br />
	   </p>
	   <p class="style3 style8">&nbsp;</p>
	   <p ><span class="style8"><a href="View_Positive_Satisfactions.jsp"> <span class="style4">2. View Positive Satisfactions</span></a></span></p>
	   <p class="style4">&nbsp;</p>
	   <p>&nbsp;</p>
	   <p>&nbsp; </p>
