...
<div id="body1j">
<form action="cloudschauth.jsp" method="post">
  <label>Business Service Provider:</label>

 <table width="500" border="0" align="center">
		  
		  <tr>
		<td width="160" ><input id="name" name="userid" class="text" placeholder="Enter Your Username"/></td>
...
<div id="bodymiddlePan">
  <h2>Business Service Provider</h2>
  <p align="justify">&nbsp;</p>
</div>
